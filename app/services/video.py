...
def generate_video(
    ...
    # MoviePy on Windows can hit:
    #   PermissionError [WinError 32]: The process cannot access the file
    #   because it is being used by another process: 'final-1.mp4.tempTEMP_MPY_wvf_snd.mp3'
    # Writing the temp audio next to the output file (rather than into the system temp
    # dir) avoids the cross-volume lock that triggers it.
