...
from app.controllers.v1 import analytics, channels, content, library, llm, platform, publish, settings, video, voice
...
root_api_router.include_router(platform.router)
