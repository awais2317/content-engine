...
class VideoParams(BaseModel):
    ...
    target_duration: int = Field(default=60, ge=30, le=300)
...
class VideoScriptParams:
    ...
    video_language: Optional[str] = ""
    target_duration: Optional[int] = Field(default=60, ge=30, le=300)
                    ...
                    "files": [
                        {
                            "name": "output013.mp3",
                            "size": 1891269,
                            "file": "./resource/songs/output013.mp3",
                        }
                    ]
                },
            },
    ...
    class Config:
        json_schema_extra = {
            "example": {
                "status": 200,
                "message": "success",
                "data": {"file": "./resource/songs/example.mp3"},
            },
        }
                    ...
                    "files": [
                        {
                            "name": "example.mp4",
                            "size": 12345678,
                            "file": "./resource/videos/example.mp4",
                        }
                    ]
                },
            },
